...
public class ScrollingCombatText extends Group {
    public ScrollingCombatText(float x, float y, float dx, float dy, float duration, Color color, String text, int textSize){
        // setup the label
    ...
    public ScrollingCombatText(float x, float y, Color color, int size, boolean success, boolean crit, int amount){
        this(
                x,
                y,
                0,
